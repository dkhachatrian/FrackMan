...
{
public:
	Actor(int x, int y, int IID, Direction dir, double imageSize, unsigned int depth, StudentWorld* sw, bool solidity = false):
...
protected:
	...
	*/
	...
	/*
	virtual bool setSize(int scale)
	{
		m_go.
	}; //only needed for dirt
	*/
